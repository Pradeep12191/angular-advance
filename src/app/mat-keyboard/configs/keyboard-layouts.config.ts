...
const keyboardLayouts: IKeyboardLayouts = {
  ...
  'alphaNumericLayoutMobile': {
    'name': 'alphaNumericLayoutMobile',
    'keys': [
      [
        ['q', 'Q', '1', '['],
        ['w', 'W', '2', ']'],
      ...
      [
        [KeyboardClassKey.Shift, KeyboardClassKey.Shift, KeyboardClassKey.Symbl, KeyboardClassKey.Num],
        ['z', 'Z', '.', '.'],
        ['x', 'X', ',', ','],
        ['c', 'C', '?', '?'],
        ['v', 'V', '!', '!'],
      ...
      [
        [KeyboardClassKey.Num, KeyboardClassKey.Num, KeyboardClassKey.Char, KeyboardClassKey.Char],
        [KeyboardClassKey.Space, KeyboardClassKey.Space, KeyboardClassKey.Space, KeyboardClassKey.Space ]
      ]
    ],
    'lang': ['en-US']
